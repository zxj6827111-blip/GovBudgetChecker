...
export default function ReanalyzeProgressDialog({
  ...
  return (
    <div data-testid="reanalyze-progress-dialog" className="fixed inset-0 z-[180] flex items-center justify-center bg-slate-950/45 p-4 backdrop-blur-sm">
      <div className="flex max-h-[90vh] w-full max-w-6xl flex-col overflow-hidden rounded-[28px] border border-white/60 bg-white shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5">
          ...
          <button
            type="button"
            data-testid="reanalyze-progress-close"
            onClick={onClose}
