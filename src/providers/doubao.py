...
class DoubaoProvider(BaseLLMProvider):
    ...
    def __init__(self, 
        ...
        model_aliases = {
            ...
            # 兼容性别名
            "doubao_pro": "doubao-1-5-pro-32k-250115",
    ...
    def parse_error(self, status_code: int, response_data: Dict[str, Any]) -> LLMError:
        ...
        # 豆包特定错误码映射
        if error_code == 'AuthenticationError' or error_type_str == 'Unauthorized' or status_code in [401, 403]:
            error_type = LLMErrorType.AUTHENTICATION
        elif error_code == 'NotFoundError' or 'model' in error_msg.lower() and 'not found' in error_msg.lower() or status_code == 404:
            error_type = LLMErrorType.MODEL_NOT_FOUND
        elif error_code == 'RateLimitError' or status_code == 429:
        ...
        return LLMError(
            ...
            message=f"Doubao API Error: {error_msg}",
