...
| 日志与指标 | `LOG_LEVEL`、`LOG_JSON`、`LOG_FILE`、`METRICS_ENABLED`、`METRICS_API_TOKEN`、`METRICS_CACHE_TTL_SECONDS`、`METRICS_MAX_JOBS`、`AUDIT_LOG_MAX_SCAN_LINES`（Task 3 新增，活动流接口单次扫描审计日志的最大行数上限，默认 20000） |
